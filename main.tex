...
\usepackage{KobeMetropolis} % Colors and other styles
...
\titlegraphic{\hfill\includegraphics[height=2cm]{figures/01_logo_basic/02_logo_clearback}} % Adds a logo 
...
\begin{columns}
	\column{0.35\linewidth}
    	\begin{figure}
        \centering
        \includegraphics[scale=.5]{figures/01_logo_basic/02_logo_clearback.png}
        \caption{Kobe Logo}
        \end{figure}
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}{A slide with a TikZ figure}
